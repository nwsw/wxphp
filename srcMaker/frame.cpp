	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "z!", &_argObj0 ) == SUCCESS)
	{
		...
		if (valid) 
		{
			if(_argObj0->type==IS_OBJECT && zend_hash_find(Z_OBJPROP_P(_argObj0), _wxResource , sizeof(_wxResource),  (void **)&tmp) == SUCCESS)
			{
				id_to_find0 = Z_RESVAL_P(*tmp);
				_ptrObj0 = zend_list_find(id_to_find0, &rsrc_type);
				if (!_ptrObj0 || (rsrc_type != le_wxObject && rsrc_type != le_wxFocusEvent))
					valid = 0;
			}
			else if(_argObj0->type==IS_LONG)
				_ptrObj0= (void *)_argObj0->value.lval;
...
PHP_METHOD(php_wxSize, SetWidth)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "l!", &_argLong0 ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxSize_php*)_this)->SetWidth((int)_argLong0);
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxSize, SetHeight)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "l!", &_argLong0 ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxSize_php*)_this)->SetHeight((int)_argLong0);
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxSize, GetWidth)
{
	...
	if (ZEND_NUM_ARGS()==0)
	{
		...
		if(valid)
		{
			...
			{
				case 0:
					ret0 =  ((wxSize_php*)_this)->GetWidth();
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxSize, GetHeight)
{
	...
	if (ZEND_NUM_ARGS()==0)
	{
		...
		if(valid)
		{
			...
			{
				case 0:
					ret0 =  ((wxSize_php*)_this)->GetHeight();
					break;
				default:
					break;
			}
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "z!|l!l!l!z!", &_argObj0 , &_argLong0 , &_argLong1 , &_argLong2 , &_argObj1 ) == SUCCESS)
	{
		...
		if(valid && _argObj1)
		{
			if (_argObj1->type==IS_OBJECT && zend_hash_find(Z_OBJPROP_P(_argObj1), _wxResource , sizeof(_wxResource),  (void **)&tmp) == SUCCESS) 
			{
				id_to_find1 = Z_RESVAL_P(*tmp);
				_ptrObj1 = zend_list_find(id_to_find1, &rsrc_type);
				if (!_ptrObj1 || (rsrc_type != le_wxObject && rsrc_type != le_wxFocusEvent))
					valid = 0;
			}
			else if(_argObj1->type==IS_LONG)
				_ptrObj1= (void *)_argObj1->value.lval;
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "l!s!z!|z!s!s!z!", &_argLong0 , &_argStr0 , &_argStr0_len , &_argObj0 , &_argObj1 , &_argStr1 , &_argStr1_len , &_argStr2 , &_argStr2_len , &_argObj2 ) == SUCCESS)
	{
		...
		if(valid && _argObj2)
		{
			if (_argObj2->type==IS_OBJECT && zend_hash_find(Z_OBJPROP_P(_argObj2), _wxResource , sizeof(_wxResource),  (void **)&tmp) == SUCCESS) 
			{
				id_to_find2 = Z_RESVAL_P(*tmp);
				_ptrObj2 = zend_list_find(id_to_find2, &rsrc_type);
				if (!_ptrObj2 || (rsrc_type != le_wxObject && rsrc_type != le_wxFocusEvent))
					valid = 0;
			}
			else if(_argObj2->type==IS_LONG)
				_ptrObj2= (void *)_argObj2->value.lval;
...
PHP_METHOD(php_wxRect, SetX)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "l!", &_argLong0 ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxRect_php*)_this)->SetX((int)_argLong0);
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxRect, SetY)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "l!", &_argLong0 ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxRect_php*)_this)->SetY((int)_argLong0);
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxRect, GetWidth)
{
	...
	if (ZEND_NUM_ARGS()==0)
	{
		...
		if(valid)
		{
			...
			{
				case 0:
					ret0 =  ((wxRect_php*)_this)->GetWidth();
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxRect, SetWidth)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "l!", &_argLong0 ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxRect_php*)_this)->SetWidth((int)_argLong0);
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxRect, GetHeight)
{
	...
	if (ZEND_NUM_ARGS()==0)
	{
		...
		if(valid)
		{
			...
			{
				case 0:
					ret0 =  ((wxRect_php*)_this)->GetHeight();
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxRect, SetHeight)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "l!", &_argLong0 ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxRect_php*)_this)->SetHeight((int)_argLong0);
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxStyledTextCtrl, SetModEventMask)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "l!", &_argLong0 ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxStyledTextCtrl_php*)_this)->SetModEventMask((int)_argLong0);
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxStyledTextEvent, GetPosition)
{
	...
	if (ZEND_NUM_ARGS()==0)
	{
		...
		if(valid)
		{
			...
			{
				case 0:
					ret0 =  ((wxStyledTextEvent_php*)_this)->GetPosition();
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxStyledTextEvent, GetModificationType)
{
	...
	if (ZEND_NUM_ARGS()==0)
	{
		...
		if(valid)
		{
			...
			{
				case 0:
					ret0 =  ((wxStyledTextEvent_php*)_this)->GetModificationType();
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxStyledTextEvent, GetLinesAdded)
{
	...
	if (ZEND_NUM_ARGS()==0)
	{
		...
		if(valid)
		{
			...
			{
				case 0:
					ret0 =  ((wxStyledTextEvent_php*)_this)->GetLinesAdded();
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxUpdateUIEvent, Check)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "b!", &_argBool0 ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxUpdateUIEvent_php*)_this)->Check(_argBool0);
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxUpdateUIEvent, Enable)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "b!", &_argBool0 ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxUpdateUIEvent_php*)_this)->Enable(_argBool0);
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxUpdateUIEvent, Show)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "b!", &_argBool0 ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxUpdateUIEvent_php*)_this)->Show(_argBool0);
					break;
				default:
					break;
			}
...
PHP_METHOD(php_wxUpdateUIEvent, SetText)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "s!", &_argStr0 , &_argStr0_len ) == SUCCESS)
	{
		...
		if(valid)
		{
			...
			{
				case 1:
					 ((wxUpdateUIEvent_php*)_this)->SetText(wxString(_argStr0, wxConvUTF8));
					break;
				default:
					break;
			}
